package com.pms.server.authorization.model;
...
public class Response<T> {
	...
	public static final Response<?> SUCCESS = new Response<>(200, "You have successfully logged in.");
	...
	public Response(T data) {
		this(200, "You have successfully logged in.");
		this.data = data;
	}
