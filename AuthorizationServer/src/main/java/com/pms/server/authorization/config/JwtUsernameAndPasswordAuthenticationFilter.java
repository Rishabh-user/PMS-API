package com.pms.server.authorization.config;
...
import com.pms.server.authorization.model.ErrorResponse;
import com.pms.server.authorization.model.LoginDetail;
import com.pms.server.authorization.model.Response;
import com.pms.server.authorization.model.User;
import com.pms.server.authorization.service.UserDetailsServiceImpl;
...
public class JwtUsernameAndPasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
		...
		if (principal instanceof User) {
			...
			String ipAddress2 = String.valueOf(request.getAttribute("ipAddress"));
			  ...
			  String userAgent = String.valueOf(request.getAttribute("userAgent")); String
						  location = String.valueOf(request.getAttribute("location"));
			if (ipAddress == null)
			...
			if (false) {
				...
				userService.saveLoginDetail(user.getUserId(), new LoginDetail(user.getIpAdress(), user.getUserAgent(), user.getLocation()));
	...
	protected void unsuccessfulAuthentication(HttpServletRequest request, HttpServletResponse response,
		...
		if (failed instanceof LockedException)
			res = new Response<>(401, "Your account has been blocked by the admin");
